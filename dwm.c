...
enum { SchemeNorm, SchemeSel, SchemeRed, SchemeBlue, SchemePurple, SchemeYellow, SchemeOrange, SchemeStatus, SchemeTagsSel, SchemeTagsNorm, SchemeInfoSel, SchemeInfoNorm }; /* color schemes */
